(ns s-exp.loch.test.server-test
  (:require [clojure.test :refer [deftest is]]
            [s-exp.loch.http.server :as srv]
            [s-exp.loch.http.server.response :as rsp]
            [s-exp.loch.http.server.request :as req]
...
(deftest test-simple-get-req
  (with-server {:s-exp.loch.http.server/join? false
                :s-exp.loch.http.server.interceptor/ctx
...
(deftest async-test
  (with-server {:s-exp.loch.http.server/join? false
                :s-exp.loch.http.server.interceptor/chain ring1/async-chain
                :s-exp.loch.http.server.interceptor/ctx
...
(deftest fast-test
  (with-server {:s-exp.loch.http.server/join? false
                :s-exp.loch.http.server/handler
                (fn [opts]
                  (srv/create-handler
